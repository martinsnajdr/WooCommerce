...
class Version_1_4_2 {
	...
	private function deduplicateCarrierPrefix(): void {
		$duplicatedCarrierPrefix = CartOrder::CARRIER_PREFIX . CartOrder::CARRIER_PREFIX;
		...
		foreach ( $productIds as $productId ) {
			...
			foreach ( $oldMeta as $optionId => $isDisallowed ) {
				$optionId             = str_replace( $duplicatedCarrierPrefix, CartOrder::CARRIER_PREFIX, $optionId );
